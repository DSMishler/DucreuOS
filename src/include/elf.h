#pragma once
// Daniel Mishler
// Yoinking this file from Dr. Marz' inclass code. Too long, didn't write.
...
typedef uint16_t Elf32_Section_t;
...
typedef struct {
    Elf32_Word_t ch_type;      /* Compression format.  */
    Elf32_Word_t ch_size;      /* Uncompressed data size.  */
    Elf32_Word_t ch_addralign; /* Uncompressed data alignment.  */
} Elf32_Chdr_t;
typedef struct {
    Elf64_Word_t ch_type; /* Compression format.  */
    Elf64_Word_t ch_reserved;
    Elf64_Xword_t ch_size;      /* Uncompressed data size.  */
    Elf64_Xword_t ch_addralign; /* Uncompressed data alignment.  */
} Elf64_Chdr_t;
...
typedef struct {
    ...
    Elf32_Section_t st_shndx; /* Section index */
} Elf32_Sym_t;
typedef struct {
    Elf64_Word_t st_name;     /* Symbol name (string tbl index) */
    unsigned char st_info;  /* Symbol type and binding */
    unsigned char st_other; /* Symbol visibility */
    Elf64_Section_t st_shndx; /* Section index */
    Elf64_Addr_t st_value;    /* Symbol value */
    Elf64_Xword_t st_size;    /* Symbol size */
} Elf64_Sym_t;
...
typedef struct {
    Elf32_Half_t vd_version; /* Version revision */
    Elf32_Half_t vd_flags;   /* Version information */
    Elf32_Half_t vd_ndx;     /* Version Index */
    Elf32_Half_t vd_cnt;     /* Number of associated aux entries */
    Elf32_Word_t vd_hash;    /* Version name hash value */
    Elf32_Word_t vd_aux;     /* Offset in bytes to verdaux array */
    Elf32_Word_t vd_next;    /* Offset in bytes to next verdef
        entry */
} Elf32_Verdef_t;
typedef struct {
    Elf64_Half_t vd_version; /* Version revision */
    Elf64_Half_t vd_flags;   /* Version information */
    Elf64_Half_t vd_ndx;     /* Version Index */
    Elf64_Half_t vd_cnt;     /* Number of associated aux entries */
    Elf64_Word_t vd_hash;    /* Version name hash value */
    Elf64_Word_t vd_aux;     /* Offset in bytes to verdaux array */
    Elf64_Word_t vd_next;    /* Offset in bytes to next verdef
        entry */
} Elf64_Verdef_t;
...
typedef struct {
    Elf32_Word_t vda_name; /* Version or dependency names */
    Elf32_Word_t vda_next; /* Offset in bytes to next verdaux
     entry */
} Elf32_Verdaux_t;
typedef struct {
    Elf64_Word_t vda_name; /* Version or dependency names */
    Elf64_Word_t vda_next; /* Offset in bytes to next verdaux
     entry */
} Elf64_Verdaux_t;
/* Version dependency section.  */
typedef struct {
    Elf32_Half_t vn_version; /* Version of structure */
    Elf32_Half_t vn_cnt;     /* Number of associated aux entries */
    Elf32_Word_t vn_file;    /* Offset of filename for this
        dependency */
    Elf32_Word_t vn_aux;     /* Offset in bytes to vernaux array */
    Elf32_Word_t vn_next;    /* Offset in bytes to next verneed
        entry */
} Elf32_Verneed_t;
typedef struct {
    Elf64_Half_t vn_version; /* Version of structure */
    Elf64_Half_t vn_cnt;     /* Number of associated aux entries */
    Elf64_Word_t vn_file;    /* Offset of filename for this
        dependency */
    Elf64_Word_t vn_aux;     /* Offset in bytes to vernaux array */
    Elf64_Word_t vn_next;    /* Offset in bytes to next verneed
        entry */
} Elf64_Verneed_t;
...
typedef struct {
    Elf32_Word_t vna_hash;  /* Hash value of dependency name */
    Elf32_Half_t vna_flags; /* Dependency specific information */
    Elf32_Half_t vna_other; /* Unused */
    Elf32_Word_t vna_name;  /* Dependency name string offset */
    Elf32_Word_t vna_next;  /* Offset in bytes to next vernaux
      entry */
} Elf32_Vernaux_t;
typedef struct {
    Elf64_Word_t vna_hash;  /* Hash value of dependency name */
    Elf64_Half_t vna_flags; /* Dependency specific information */
    Elf64_Half_t vna_other; /* Unused */
    Elf64_Word_t vna_name;  /* Dependency name string offset */
    Elf64_Word_t vna_next;  /* Offset in bytes to next vernaux
      entry */
} Elf64_Vernaux_t;
...
typedef struct {
    Elf32_Word_t n_namesz; /* Length of the note's name.  */
    Elf32_Word_t n_descsz; /* Length of the note's descriptor.  */
    Elf32_Word_t n_type;   /* Type of the note.  */
} Elf32_Nhdr_t;
typedef struct {
    Elf64_Word_t n_namesz; /* Length of the note's name.  */
    Elf64_Word_t n_descsz; /* Length of the note's descriptor.  */
    Elf64_Word_t n_type;   /* Type of the note.  */
} Elf64_Nhdr_t;
...
/* Move records.  */
typedef struct {
    Elf32_Xword_t m_value;  /* Symbol value.  */
    Elf32_Word_t m_info;    /* Size and index.  */
    Elf32_Word_t m_poffset; /* Symbol offset.  */
    Elf32_Half_t m_repeat;  /* Repeat count.  */
    Elf32_Half_t m_stride;  /* Stride info.  */
} Elf32_Move_t;
typedef struct {
    Elf64_Xword_t m_value;   /* Symbol value.  */
    Elf64_Xword_t m_info;    /* Size and index.  */
...
// start a process from an elf file (passed as a buffer through elf)
