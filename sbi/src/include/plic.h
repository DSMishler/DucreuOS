// allegedly, Brandon hates this and prefers header guards
#pragma once
#include <stdint.h>

#define PLIC_BASE           0x0c000000UL
#define PLIC_CEILING        0x0c2FFFFFUL
#define PLIC_PRIORITY_BASE  0x4
#define PLIC_PENDING_BASE   0x1000
#define PLIC_ENABLE_BASE    0x2000
#define PLIC_ENABLE_STRIDE  0x80
#define PLIC_CONTEXT_BASE   0x00200000
#define PLIC_CONTEXT_STRIDE 0x1000

#define PLIC_MODE_MACHINE    0x0
#define PLIC_MODE_SUPERVISOR 0x1

#define PLIC_INT_CODE_IRQ0   32
#define PLIC_INT_CODE_IRQ1   33
#define PLIC_INT_CODE_IRQ2   34
#define PLIC_INT_CODE_IRQ3   35
